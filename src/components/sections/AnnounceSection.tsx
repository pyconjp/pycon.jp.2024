      ...
      <div className="lg:w-8/12 w-11/12 mx-auto flex flex-col gap-6">
        {announce.map(({name, url}, index) => (
          <Link key={index} href={url} rel='noopener noreferrer' target='_blank'>
            <div
              className="flex gap-6 bg-primary-500 text-white rounded-tr-[3rem] rounded-bl-[3rem] items-center py-4 px-8 relative after:bg-secondary after:absolute after:w-full after:h-full after:-z-10 after:left-0 after:top-2.5 after:rounded-tr-[3rem] after:rounded-bl-[3rem]">
