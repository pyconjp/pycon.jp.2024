...
export function PatronCard({patron}: { patron: Patron }) {
  return <div className='flex flex-col gap-3 items-center'>
    <div
      className='aspect-square relative after:bg-secondary after:absolute after:w-full after:h-full after:z-0 after:top-1 after:left-1 after:rounded-tl-3xl after:rounded-br-3xl'>
